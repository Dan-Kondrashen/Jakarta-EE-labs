...
<table>
	...
	<div class="text-article">
		<form method="POST" action="">
			...
			<div class="col-sm-6">
				<input type="text" name="id" class="form-control" readonly value="${regionEdit[0].getRegionID()}"/>
			</div>
			</div>
			<div class="mb-3 row">
			<label for="regionName" class="col-sm-4 col-form-label">Название региона</label> 
			<div class="col-sm-6">
				<input type="text" name="regionName" class="form-control" value="${regionEdit[0].getRegionName()}"/>
			</div>
			</div>
			<div class="mb-3 row">
			<label for="regionDesc" class="col-sm-4 col-form-label">Описание региона</label> 
			<div class="col-sm-6">
				<input type="text" name="regionDesc" class="form-control" value="${regionEdit[0].getRegionDesc()}"/>
			</div>
			</div>
			<p>
