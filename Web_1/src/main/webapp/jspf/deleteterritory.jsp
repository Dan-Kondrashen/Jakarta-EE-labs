...
<title>Удаление территории</title>
<head>
<!-- Bootstrap CSS -->
...
<table>
	...
	<section>
	<article>
	<h3>Удаление территории</h3>
	<div class="text-article">
		<form method="POST">	
			<div class="mb-3 row">
			<label for="id" class="col-sm-4 col-form-label">Код территории</label> 
			<div class="col-sm-6">
				<input type="text" name="id" class="form-control" readonly value="${territoryDelete[0].getTerID()}"/>
			</div>
			</div>	
			<div class="mb-3 row">
			<label for="terDesc" class="col-sm-4 col-form-label">Описание</label> 
			<div class="col-sm-6">
				<input type="text" name="terDesc" class="form-control" readonly value="${territoryDelete[0].getTerDesc()}"/>
			</div>
			</div>
			<div class="mb-3 row">
				<label for="region" class="col-sm-4 col-form-label">Регион</label>
				<div class="col-sm-6">
					<input type="text" name="region" class="form-control" readonly value="${territoryDelete[0].getRegion()}"/>
				</div>
			</div>
			<p>
